...
class MyDietician(KnowledgeEngine):
    ...
    def calorie_tt(self):
        ...
        snacks = 'Iced - blended coffee & peanut butter protein shake + wafers'
        dinner = 'chicken breast+ white rice+ bell pepper +Green onion+ onion+ mushrooms+2 tbsp soy sauce +1 egg'




print('calorie',ki.dkc)

engine = MyDietician()
engine.reset()
engine.declare(mass(calorie=ki.dkc, preference=sql2.ex.preference))
    # engine.declare(mass(gender='female'))
engine.run()
